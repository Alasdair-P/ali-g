...
class SBD(torch.optim.Optimizer):
    def __init__(self, params, eta=None, k=1, momentum=0, projection_fn=None, zero_plane=True, momentum_forward=False, sgdf=False, eps=1e-8, debug=False):
