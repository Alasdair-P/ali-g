...
def create_jobs():
    ...
    wrn_opts = " --depth 40 --width 4 --no_tb --no_visdom "
    dn_opts = " --depth 40 --growth 40 --no_tb --no_visdom --epochs 300 "
    gcn_opts = " --depth 5 --width 300 --epochs 500 "

    with open("reproduce/hparams/cifar_sgd_constant_step.yaml", "r") as f:
    # with open("reproduce/hparams/noisey_05.yaml", "r") as f:
