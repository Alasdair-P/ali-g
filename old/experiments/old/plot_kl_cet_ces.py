...
def main(args):
    ...
    args.depth = 20
    # args.load_model = '/data0/results/cifar100/resnet100-sgd--eta-0.1--l2-None--b-128--run-distill32/best_model.pkl'
    # args.load_model = '/data0/results/cifar100/resnet100-alig--eta-0.1--l2-0--b-128--run-teacher32_l_bound0.5_abs_no_data_aug_teacher_eval/model.pkl'
    # args.load_model = '/data0/results/cifar100/resnet100-alig--eta-1.0--l2-0--b-512--run-teacher32_l_bound0.5_nodataaug/model.pkl'
    # args.load_model = '/data0/results/cifar100/resnet100-alig--eta-1.0--l2-0--b-512--run-teacher32_l_bound0.5_nodataaug/best_model.pkl'
    # args.load_model = '/data0/results/cifar100/resnet100-sgd--eta-1.0--l2-0--b-128--run-teacher32_automatic_lower_bound_reduction_0.5/model.pkl'
    args.load_model = '/data0/results/cifar100/resnet100-sgd--eta-1.0--l2-0--b-128--run-teacher32_kl_loss/model.pkl'
